...
class PropertiesConceptsRepository(BaseRepository):
    dto_model= PropertiesConceptsResponse
    
    def __init__(self, db: Session):
        self.db = db

    def get_by_id(self, properties_concepts_id: int) -> Optional[PropertiesConceptsResponse]:
    ...
    def create(self, properties_concepts: CreatePropertiesConcepts) -> PropertiesConceptsResponse:
    ...
    def update(self, properties_concepts_id: int, propertiesConcepts: UpdatePropertiesConcepts) -> PropertiesConceptsResponse:
