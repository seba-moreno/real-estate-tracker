...
def add_initial_properties(session: Session) -> None:
    ...
    prop3 = Property(
        id=3,
        location="Campo en algun lugar",
        area=250,
        valuation="2000000",
        details="Lote de 250 has en algun lugar",
    )
...
def add_initial_contracts(session: Session) -> None:
    contract1 = Contract(
        id=1, property_id=1, start_date=date(2023, 1, 20), end_date=date(2026, 1, 19)
    )
    contract2 = Contract(
        id=2, property_id=3, start_date=date(2025, 12, 20), end_date=date(2026, 6, 19)
    )
