...
class PropertyService:
    ...
    def get_property_by_id(self, property_id: int) -> None | PropertyResponse:
        ...
        if not existing_property:
            self.logger.warning(
                "Get by id failed: Property not found",
    ...
    def create_property(self, property: CreateProperty) -> PropertyResponse:
        ...
        try:
            ...
            self.logger.info(
                ...
                extra={"data": created_property.model_dump()},
            )
    ...
    def update_property(
        self, property_id: int, property: UpdateProperty
    ) -> PropertyResponse:
        existing_property = self.property_repository.get_by_id(property_id)

        if not existing_property:
            self.logger.warning(
                "Update failed: Property not found", extra={"property_id": property_id}
            )
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND, detail="Property not found"
            )
        ...
        payload = property.model_dump()
        self.logger.info(
            "Updating property", extra={"property_id": property_id, "data": payload}
        )
        ...
        try:
            ...
            self.logger.info(
                ...
                extra={"data": updated_property.model_dump()},
            )
            return updated_property
        except Exception:
            self.logger.exception(
                "Failed to update Property",
                extra={"property_id": property_id, "data": payload},
            )
            raise HTTPException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
                detail="An unexpected error occurred while creating the property",
    ...
    def delete_property(self, property_id: int) -> None:
        ...
        if not existing_property:
            self.logger.warning(
                "Delete failed: Property not found", extra={"property_id": property_id}
            )
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND, detail="Property not found"
            )
        ...
        try:
            ...
            self.logger.info(
                "Property deleted successfully", extra={"property_id": property_id}
            )
        except Exception:
            self.logger.exception(
                "Failed to delete Property", extra={"property_id": property_id}
